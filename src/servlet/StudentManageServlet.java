 ...
 */
@WebServlet(name = "StudentManageServlet", value = "/servlet/StudentManageServlet")
public class StudentManageServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.setCharacterEncoding("UTF-8");
        int page = Integer.parseInt(request.getParameter("page"));
        StudentWrapper students = StudentDao.queryPagingStudent(page);

        int num = students.getNum();
        ...
        for(int i = 1 ;i <= pages ;i ++){
            if(i == page){
                sb.append("<a href=../../servlet/StudentManageServlet?page=")
                        .append(i)
        ...
        response.sendRedirect("../jsp/view/students_manage.jsp");
    }
